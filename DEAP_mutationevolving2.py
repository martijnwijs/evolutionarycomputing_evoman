...
toolbox.register("mate", tools.cxUniform, indpb=0.9) # you can take a independent variable or place it further in the code
toolbox.register("mutate", tools.mutGaussian, mu=0, indpb=mutationrate) # later on, coevolve this value
...
def main():
    ...
    while max(fits) < 100 and g < 1000:
        ...
        for mutant in offspring:
            mutationstepsize = abs(mutant[-1])   #mutant[-1]
            print("stepsize:   ", mutationstepsize)
            toolbox.mutate(mutant, sigma=mutationstepsize)

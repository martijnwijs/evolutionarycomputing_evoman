...
toolbox.register("mate", tools.cxUniform) # you can take a independent variable or place it further in the code
toolbox.register("mutate", tools.mutGaussian, mu=0, sigma=1, indpb=0.2) # later on, coevolve this value
toolbox.register("select", tools.selTournament, k=5, tournsize=5)  # k number of individuals too select change these values for premature convergence


def main():
    pop = toolbox.population(n=80) # change population size here
